      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-32 text-center">
        <div className="animate-fade-up">
          <div className="inline-flex items-center space-x-3 bg-emerald-500/20 backdrop-blur-md px-6 py-2 rounded-full border border-emerald-400/30 mb-8 shadow-2xl">
            ...
            <span className="text-emerald-400 font-black uppercase tracking-[0.4em] text-[10px]">We offer wide range of services and products</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 justify-center">
            ...
            >
              <i className="fa-solid fa-calendar-check mr-3 text-emerald-400 group-hover:scale-110 transition-transform"></i>
              BOOK NOW
            </button>
          </div>
        </div>
